...
| **Contenido** | Marcadores de pendiente reales, texto de relleno, enlaces roídos, copia desactualizada, metadatos ausentes | La ruta y el fragmento |
| **Mantenibilidad** | Duplicación, valores hardcodeados, deuda declarada en los docs, documentación desfasada respecto al código | La deuda citada en `CLAUDE.md`; los dos sitios duplicados |
