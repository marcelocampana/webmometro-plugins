...
**Slash Command:** `/brand-voice-pro:discover-brand`

```
/brand-voice-pro:discover-brand
/brand-voice-pro:discover-brand Acme Corp
```
...
**Slash Command:** `/brand-voice-pro:generate-guidelines`

```
/brand-voice-pro:generate-guidelines
/brand-voice-pro:generate-guidelines from the discovery report and these 3 PDFs
```
...
**Slash Command:** `/brand-voice-pro:enforce-voice`

```
/brand-voice-pro:enforce-voice Draft a cold email to a VP of Sales at a mid-market SaaS company
/brand-voice-pro:enforce-voice Write a LinkedIn post announcing our new feature
```
...
3. Run `/brand-voice-pro:discover-brand` — Claude searches your connected knowledge bases for brand materials automatically
4. Run `/brand-voice-pro:generate-guidelines` to produce a durable set of guidelines from the discovery report
5. Use `/brand-voice-pro:enforce-voice` when creating content — sales emails, proposals, LinkedIn posts, anything customer-facing
...
├── commands/
│   ├── discover-brand.md                        # /brand-voice-pro:discover-brand
│   ├── enforce-voice.md                         # /brand-voice-pro:enforce-voice
│   └── generate-guidelines.md                   # /brand-voice-pro:generate-guidelines
├── settings/
