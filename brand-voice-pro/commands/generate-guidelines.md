...
Generate comprehensive, LLM-ready brand voice guidelines from whatever sources the user provides — brand documents, conversation transcripts, a discovery report from `/brand-voice-pro:discover-brand`, or direct input.
...
4. If nothing is available, suggest running `/brand-voice-pro:discover-brand` first
